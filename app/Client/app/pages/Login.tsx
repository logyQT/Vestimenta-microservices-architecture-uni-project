...
export function Login() {
  const [email, setEmail] = useState("demo@vestimenta.com");
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="bg-zinc-900/80 border border-zinc-800 p-8 md:p-12 relative backdrop-blur-md">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-black/50 border border-zinc-800 px-10 py-3 text-white focus:border-gold-500 outline-none transition-colors"
                  required 
                />
              </div>
            </div>
          ...
          <div className="mt-8 text-center">
             <p className="text-zinc-500 text-sm">New to Vestimenta? <button onClick={() => navigate('/register')} className="text-gold-500 hover:underline ml-1">Create Account</button></p>
          </div>
        </div>
      </div>
    </section>
